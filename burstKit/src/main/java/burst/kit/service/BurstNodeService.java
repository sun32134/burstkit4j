...
public interface BurstNodeService {
    ...
    /**
     * Get the transactions of height
     * @param height The height of the block
     * @return The height's transactions, wrapped in a single
     */
    Single<Transaction[]> getTransactionsByHeight(Long height); // TODO filtering
    ...
    /**
     * Set the reward recipient of the account
     * @param recipient The recipient account
     * @param secretPhrase miner's passphrase
     * @param deadline
     * @param feeNQT transaction fee
     * @return The reward recipient, wrapped in a single
     */
    Single<TransactionResponse> setRewardRecipient(BurstAddress recipient, String secretPhrase, String deadline, String feeNQT);
