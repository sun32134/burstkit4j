...
public final class BurstKitUtils {
    ...
    private static final AtomicReference<String> addressPrefix = new AtomicReference<>("BPC");
    private static final AtomicReference<String> valueSuffix = new AtomicReference<>("BPC");
