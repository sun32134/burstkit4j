...
public final class BurstKitUtils {
    ...
    private static final AtomicReference<String> addressPrefix = new AtomicReference<>("DAAS");
    private static final AtomicReference<String> valueSuffix = new AtomicReference<>("DAAS");
