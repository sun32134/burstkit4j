...
public class CompositeBurstNodeService implements BurstNodeService {
    ...
    public Single<Transaction[]> getTransactionsByHeight(Long height) {
        return performFastest(service -> service.getTransactionsByHeight(height));
    }
    ...
    public Single<TransactionResponse> setRewardRecipient(BurstAddress recipient, String secretPhrase, String deadline, String feeNQT) {
        return performFastest(service -> service.setRewardRecipient(recipient, secretPhrase, deadline, feeNQT));
    }
